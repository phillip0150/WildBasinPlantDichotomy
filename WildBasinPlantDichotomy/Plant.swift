...
class Plant
{
    ...
    class func createAlternateSmooth() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Gum Elastic (Sideroxylon lanuginosum)", description: "Shrub or small tree with sharp spines. White flowers bloom in the Spring. Drought tolerant in the summer. Can live in wooded and residential areas and is a suitable plant for xeriscaping. Found in S US and native to Texas.", image: "gum elastic 1", otherimage: "gum elastic 2", url: ""))
    ...
    class func createAlternateMoreThan() -> [Plant]
    {
        ...
        //Create a plant object
        plants.append(Plant(name: "Live Oak (Quercus virginiana)", description: "Tree with strong, large trunk that supports large limbs that produce horizontal branches that usually form a broad rounded canopy. Leaves are dark green and waxy and fall in the early spring only to be immediately replaced by new leaves. Live Oaks are found in wooded areas and residential landscapes and public spaces. Grows in Texas, California, SE US.", image: "live oak 1", otherimage: "live oak 2", url: ""))
        ...
        plants.append(Plant(name: "Sugar hackberry (Celtis Laevigata wild)", description: "Tree with smooth light brown trunk with exposed grey patches. Limbs are thin and branches carry ovate, narrow leaves that are greenish yellowish. Tends to spread and form a crowned canopy and leaves tend to droop. Produces fleshy, red-brown fruit that is enjoyed by mockingbirds, robins, and other songbirds. Region is Coastal Plains to S. Mexico.", image: "sugar hackberry 1", otherimage: "sugar hackberry 2", url: ""))

        plants.append(Plant(name: "American Elm (Ulmus americana)", description: "Large tree with rough, dull brown bark. Limbs produce many branchlets that carry dark green, ovate leaves that are distinctly toothed around the edges and pointed at the tip. Leaves vary in color in the fall, usually turning light yellow. The body of tree is a vase while the branches form a large crown that tends to droop. Range -  Central, S, SE US.", image: "american elm 1", otherimage: "american elm 2", url: ""))
    ...
    class func createOppositeVine() -> [Plant]
    {
        ...
        //Create a plant object
        plants.append(Plant(name: "Coral Honeysuckle (Lonicera sempervirens)", description: "Climbing Vine with orange to brown bark and smooth, glossy ovate leaves that are deep green. Tubular flowers are red with yellow interiors and are arranged in a circular pattern of three to four around the base of a leaf. Blooms mid-spring followed by red berry fruit. Range - NE to S. US.", image: "coral honeysuckle 1", otherimage: "coral honeysuckle 2", url: ""))
        
        plants.append(Plant(name: "White Honeysuckle (Lonicera albiflora)", description: "Deciduous shrub with brown semi-smooth bark. Branches sometimes twine. Covered with broad ovate leaves that appear dull-green. Small, white, tubular flowers. Red-orange berries grow in clusters of 3-4. A favorite and important plant among pollinators. Range - S. US.", image: "white honeysuckle 1", otherimage: "white honeysuckle 2", url: ""))
        
        plants.append(Plant(name: "Japanese Honeysuckle (Loncera japonica)", description: "Evergreen climbing vine with oval shaped leaves. Yellow tubular flowers in clusters of 4-5 grow during the summer followed by black berries. The Japanese honeysuckle can adapt to many environments and is considered a disturbance in forests because it can take over habitats. Range - Native to E. Asia; Can be invasive in SE US.", image: "japanese honeysuckle 1", otherimage: "japanese honeysuckle 2", url: ""))
    ...
    class func createOppositeSmooth() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Privet (Forestiera acuminata)", description: "Shrub or small tree. Bark ranges from bright green to dull brown depending on the age of the plant. Trunk is usually smooth in texture. Leaves are ovate, glossy green, and arranged in pairs. Yellow-tipped flowers protrude off the plant in the shape of splinters. Flowers are most distinct on male plants while fruits grow on the female. The fruits of the Privet are purple to black in color and olive-shaped. Range - S. US.", image: "privet 1", otherimage: "privet 2", url: ""))
    ...
    class func createCompoundDoublyPinnate() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Honey Mesquite (Prosopis glandulosa)", description: "Deciduous shrub or small tree with sharp thorns that protrude from its branches. Long, feather-like leaves are deep green and grow along the axis of the branches. Flowers are yellow-green and grow in dense racemes blooming April - August. Fruits follow and are small sweet-tasting pods. When dried, the fruit is ground into powder to make mesquite flour. Range - S. US.", image: "honey mesquite 1", otherimage: "honey mesquite 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Cat Claw Mimosa (Mimosa aculeaticarpa)", description: "Shrub with windmill-like prickles that can catch onto clothing. Leaves grow in pairs of 8 along the axis and can be up ⅛ inch long. Flowers are small and pink and form fluffy clusters. They appear in the spring and early summer. Fruit is a dry pod, light brown to red in color, and has prickles on its edges. Range - S. US.", image: "cat's claw mimosa 1", otherimage: "cat's claw mimosa 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Pink Mimosa (Mimosa borealis)", description: "Deciduous shrub with distinct prickly puff balls that grow in the spring and are an important nectar source for pollinators. Flowers are fragrant. Leaves are long, deep green, and grow in pairs of 8 along the axis with narrow tips. Generally grows on limestone hills or rocky soils. Range - S. US.", image: "pink mimosa 1", otherimage: "pink mimosa 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Chinaberry (Sapindus saponaria)", description: "Deciduous round-crowned tree with dark gray bark and branches that tend to loop. Leaves can grow up to 18 inches long and can have up to 24 paired leaflets. White to cream-colored flowers grow in pyramidal panicles and are small individually but grow in large clusters. Fruits are oval, translucent, and look similar to dried grapes or tomatoes. Fruit are orange-gold in color and contain alkaloid saponin, a toxic glucoside, that is poisonous. Range - Central and S. US.", image: "chinaberry 1", otherimage: "chinaberry 2", url: "www.google.com"))
    ...
    class func createPinnate4to10Leaflets() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Box Elder (Acer negundo)", description: "Small to medium sized tree with a typically short trunk. Leaves are green, long, ovate in shape. Leaves are divided into 2-3 leaflets. Fruits droop in clusters off the tips of the branches and are typically pale yellow in color and bloom in the fall. Range - Central and SE US.", image: "box elder 1", otherimage: "box elder 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Red ash (Fraxinus pensylvanica)", description: "Tree with a single trunk and spreading branches. Leaves are ovate with a pointed tip and semi-toothed margins, typically in clusters of 5-9 leaflets. Flowers are small and also grow in clusters. Fruits are typically dry, pale white and long. This tree is a good nesting site for birds and its red bark can be used to produce a red dye. Range - NE, S, and Central US.", image: "red texas ash 1", otherimage: "red texas ash 2", url: "www.google.com"))
    ...
    class func createGreaterThan10LessThanHalfInch() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Black Dalea (Parkinsonia aculeata)", description: "Shrub or small tree known for its bright yellow flowers that bloom in spring and summer. Leaves are long and thin. Pollinators are drawn by the plant’s nectar and bright colors.  Requires full sun, but can grow in any soil type. Range - S. US.", image: "black dalea 1", otherimage: "black dalea 2", url: "www.google.com"))
        
        //NEED DESCRIPTION
        plants.append(Plant(name: "Texas Kidneywood", description: "The leaves have a tangerine scent when crushed. Its flowers are very attractive to bees and butterflies, as the whole plant is to deer. Range: south Texas, more often in the northern portions.", image: "texas kidneywood 1", otherimage: "texas kidneywood 2", url: "www.google.com"))
        
        //NEED DESCRIPTION
        plants.append(Plant(name: "Retama", description: "The flowers are pollinated by bees. The fruit is a seedpod, leathery in appearance, light brown when mature. Branches are armed with needle-sharp spines.", image: "retama 1", otherimage: "retama 2", url: "www.google.com"))
    ...
    class func createGreaterThan10GreaterThanHalfInch() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Lindheimer senna (Senna lindheimeriana)", description: "Deciduous shrub with bright yellow flowers that have 5 oval petals that are soft, crimped at the edges, and very attractive to pollinators. Leaves are divided into 2-3 leaflets and are small, ovate, and have a pointed tip with small hairs on the surface. Flowers bloom late summer - early fall. Seeds are eaten by birds. Range - S. US.", image: "lindheimer senna 1", otherimage: "lindheimer senna 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Flameleaf Sumac (Rhus lanceolata)", description: "Deciduous tree that forms thickets where it grows. Its bark is pale gray and branches are thin and smooth. Pyramidal panicles grow deep red fleshy fruit in the fall. Flowers are insignificant and bloom in the summer. Typically grows on limestone hillsides and rocky areas. Food source for deer and a variety of birds including bobwhites and pheasants. Range - S. US.", image: "flameleaf sumac 1", otherimage: "flameleaf sumac 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Soapberry (Sapindus saponaria)", description: "Deciduous round-crowned tree with dark gray bark and branches that tend to loop. Leaves can grow up to 18 inches long and can have up to 24 paired leaflets. White to cream-colored flowers grow in pyramidal panicles and are small individually but grow in large clusters. Fruits are oval, translucent, and look similar to dried grapes or tomatoes. Fruit are orange-gold in color and contain alkaloid saponin, a toxic glucoside, that is poisonous. Range - Central and S. US.", image: "soapberry 1", otherimage: "soapbery 2", url: "www.google.com"))
        
        plants.append(Plant(name: "Little Walnut (Juglans microcarpa)", description: "Small tree or shrub. Smooth trunk with light striations on bark. Leaves are pinnately composed, long, slightly toothed, and narrow at the tip. Squirrels and humans consume the nut. Range - S. U.S.", image: "texas walnut 1", otherimage: "texas walnut 2", url: "www.google.com"))
