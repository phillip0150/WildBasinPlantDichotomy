...
class Plant
{
    ...
    class func createAllPlantArray() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Gum Elastic (Sideroxylon lanuginosum)", description: "Shrub or small tree with sharp spines. White flowers bloom in the Spring. Drought tolerant in the summer. Can live in wooded and residential areas and is a suitable plant for xeriscaping. Found in S US and native to Texas.", image: #imageLiteral(resourceName: "gum elastic 1"), otherimage: #imageLiteral(resourceName: "gum elastic 2"), url: "http://www.inaturalist.org/taxa/128748-Sideroxylon-lanuginosum"))
        ...
        plants.append(Plant(name: "Snakewood (Colubrina texenis)", description: "Small shrub that grows no bigger than 6 feet. Its bark is smooth and grey, but is marked with scaly patches that resemble snakeskin. Leaves are small and dull greenish grey. Flowers bloom in spring and fruit is eaten by deer and various birds. Range - Native to Texas and NE Mexico.", image: #imageLiteral(resourceName: "snakewood 1"), otherimage: #imageLiteral(resourceName: "snakewood 2"), url: "http://www.inaturalist.org/taxa/160814-Colubrina-texensis"))
    ...
    class func createAlternateSmooth() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Gum Elastic (Sideroxylon lanuginosum)", description: "Shrub or small tree with sharp spines. White flowers bloom in the Spring. Drought tolerant in the summer. Can live in wooded and residential areas and is a suitable plant for xeriscaping. Found in S US and native to Texas.", image: #imageLiteral(resourceName: "gum elastic 1"), otherimage: #imageLiteral(resourceName: "gum elastic 2"), url: ""))
    ...
    class func createAlternateLessThan() -> [Plant]
    {
        ...
        //Create a plant object
        plants.append(Plant(name: "Snakewood (Colubrina texenis)", description: "Small shrub that grows no bigger than 6 feet. Its bark is smooth and grey, but is marked with scaly patches that resemble snakeskin. Leaves are small and dull greenish grey. Flowers bloom in spring and fruit is eaten by deer and various birds. Range - Native to Texas and NE Mexico.", image: #imageLiteral(resourceName: "snakewood 1"), otherimage: #imageLiteral(resourceName: "snakewood 2"), url: ""))
    ...
    class func createOppositeVine() -> [Plant]
    {
        ...
        plants.append(Plant(name: "White Honeysuckle (Lonicera albiflora)", description: "Deciduous shrub with brown semi-smooth bark. Branches sometimes twine. Covered with broad ovate leaves that appear dull-green. Small, white, tubular flowers. Red-orange berries grow in clusters of 3-4. A favorite and important plant among pollinators. Range - S. US.", image: #imageLiteral(resourceName: "white honeysuckle 1"), otherimage: #imageLiteral(resourceName: "white honeysuckle 2"), url: ""))
    ...
    class func createOppositeToothed() -> [Plant]
    {
        ...
        //Create a plant object
        plants.append(Plant(name: "Elbow bush (Forestiera pubescens)", description: "Shrub from the olive family. When grown in open space can form thickets with brown to gray twigs protruding off branchlets. Leaves are small, ovate, and broad at the base with a pointed narrow tip. Small yellow flowers grow in clusters on the twigs of the plant. The female Elbow bush produces fleshy dark blue to purple fruit. Fruit is enjoyed by small mammals and birds. Range - S. US.", image: #imageLiteral(resourceName: "elbow bush 1"), otherimage: #imageLiteral(resourceName: "elbow bush 2"), url: ""))
        ...
        plants.append(Plant(name: "Wand Butterfly Bush (Buddleja racemosa)", description: "Small shrub with light brown stems and large rigid leaves that resemble arrowheads in shape. Flowers grow in tight groups on shoots that are covered with whisker-like hairs. Flowers are present in the summer. This plant is endemic to Texas and is found in limestone crevices. Range - Texas.", image: #imageLiteral(resourceName: "wand butterfly bush 1"), otherimage: #imageLiteral(resourceName: "wand butterfly bush 2"), url: ""))
    ...
    class func createGreaterThan10LessThanHalfInch() -> [Plant]
    {
        ...
        plants.append(Plant(name: "Black Dalea (Parkinsonia aculeata)", description: "Shrub or small tree known for its bright yellow flowers that bloom in spring and summer. Leaves are long and thin. Pollinators are drawn by the plant’s nectar and bright colors.  Requires full sun, but can grow in any soil type. Range - S. US.", image: #imageLiteral(resourceName: "black dalea 1"), otherimage: #imageLiteral(resourceName: "black dalea 2"), url: "www.google.com"))
